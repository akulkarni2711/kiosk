		...
		checkoutButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (checkCreditCardNumber() == false) {
					JOptionPane.showMessageDialog(null, "Please enter a valid credit card number", "Joe's Kiosk",
							JOptionPane.ERROR_MESSAGE);
				} else if (checkCVV() == false) {
					JOptionPane.showMessageDialog(null, "Please make sure that the CVV code is valid", "Joe's Kiosk",
							JOptionPane.ERROR_MESSAGE);
		...
		if (creditCardNumber == null || creditCardNumber.length() == 0) {
			...
			if (totalSum % 10 == 0) {
				if (((number.substring(0, 2).equals("34")) || (number.substring(0, 2).equals("37")))
						&& (length == 15)) {
					return true;
				} else if (((number.substring(0, 2).equals("51")) || (number.substring(0, 2).equals("52"))
						|| (number.substring(0, 2).equals("53")) || (number.substring(0, 2).equals("54"))
						|| (number.substring(0, 2).equals("55"))) && (length == 16)) {
					return true;
