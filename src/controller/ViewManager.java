...
public class ViewManager {
	...
	public void goToCart() {
		if (Cart.totalCost <= 0) {
			JOptionPane.showMessageDialog(null, "You can go to an empty cart", "Joe's Kiosk",
	...
	public void addItem(int itemID, int quantity) {
		JOptionPane.showMessageDialog(null, "Item succesfully added from cart", "Joe's Kiosk",
	...
	public void removeItemFromCart(int itemID) {
		c.removeItem(itemID);
		JOptionPane.showMessageDialog(null, "Item succesfully removed from cart", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeItemName(String newItemName, Item item) {
		...
		JOptionPane.showMessageDialog(null, "Item name succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeItemPrice(double newItemPrice, Item item) {
		...
		JOptionPane.showMessageDialog(null, "Item price succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeItemDescription(String newItemDescription, Item item) {
		...
		JOptionPane.showMessageDialog(null, "Item description succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeItemPicture(Image newItemPicture, Item item) {
		...
		JOptionPane.showMessageDialog(null, "Item picture succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeEmployeeFirstName(String newFirstName, Employee employee) {
		...
		JOptionPane.showMessageDialog(null, "Employee first name succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeEmployeeLastName(String newLastName, Employee employee) {
		...
		JOptionPane.showMessageDialog(null, "Employee last name succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeEmployeeEmail(String newEmail, Employee employee) {
		...
		JOptionPane.showMessageDialog(null, "Employee email address succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeEmployeePhone(Long newPhone, Employee employee) {
		...
		JOptionPane.showMessageDialog(null, "Employee phone number succesfully changed", "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void changeEmployeePin(int newPin, Employee employee) {
		...
		JOptionPane.showMessageDialog(null, "The new pin is: " + newPin, "Joe's Kiosk",
				JOptionPane.INFORMATION_MESSAGE);
	...
	public void removeEmployee(Employee employee) {
		if (Kiosk.employees.size() <= 1) {
			JOptionPane.showMessageDialog(null, "You can not remove the last employee", "Joe's Kiosk",
					JOptionPane.ERROR_MESSAGE);
		} else {
